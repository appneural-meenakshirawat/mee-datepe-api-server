...
export declare class PreferencesService {
    ...
    constructor(preferencesModel: Model<IPreference>);
    createPreferences(createPreferencesDto: CreatePreferencesDto): Promise<import("mongoose").Document<unknown, {}, IPreference> & IPreference & {
        _id: import("mongoose").Types.ObjectId;
    }>;
    getPreferences(type: string): Promise<{
        _id: import("mongoose").Types.ObjectId;
        name: string;
    }[]>;
